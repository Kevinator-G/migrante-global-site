...
const servicios = [
  ...
  },
  {
    ...
    descripcion:
      'Habitaciones amuebladas verificadas en el cantón de Zúrich desde 1.150 CHF/mes. Te acompaño con el contrato, el depósito y la llegada.',
    precio: 200,
    moneda: 'CHF',
    precioTipo: 'Consultoría de acompañamiento · Pago único',
    tag: 'Disponibles',
    tagColor: '#10b981',
    destacado: false,
  ...
  },
  {
    ...
    descripcion:
      'Acceso a nuestra red de migrantes latinos en Suiza. Networking, eventos y recursos actualizados.',
    precio: 0,
    moneda: '',
    precioTipo: 'Acceso gratuito',
    tag: 'Gratis',
    tagColor: '#10b981',
    destacado: false,
