...
const COUNTRIES: Record<string, CountryInfo> = {
  ...
  austria: {
    name: 'Austria',
    emoji: '🇦🇹',
    heroImage: 'https://images.unsplash.com/photo-1516550135131-a88b60e6ee10?w=1920&q=85&auto=format&fit=crop',
      ...
      <main className="min-h-screen" style={{ background: '#0d1117' }}>
        ...
        <section className="relative h-[65vh] min-h-[480px] flex items-end overflow-hidden">
          ...
          <div
            ...
            style={{
              background:
                'linear-gradient(to bottom, rgba(0,0,0,0.35) 0%, rgba(0,0,0,0.45) 40%, rgba(13,17,23,0.92) 80%, #0d1117 100%)',
            }}
          />
