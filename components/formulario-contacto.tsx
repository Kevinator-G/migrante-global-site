        ...
        >
          ...
          >
            ...
            <div>
              ...
              <div className="text-white/45 text-xs">+41 77 233 73 53</div>
            </div>
          </a>
          ...
          >
            <div className="w-12 h-12 rounded-xl flex items-center justify-center flex-shrink-0 transition-transform duration-300 group-hover:scale-110"
              ...
              <Mail className="w-6 h-6" style={{ color: '#c9a96e' }} />
            </div>
            <div>
              <div className="font-bold text-white text-sm mb-0.5">Email</div>
              <div className="text-white/45 text-xs">hola@migranteglobal.ch</div>
            </div>
          </a>
        </motion.div>
